...
def encrypter(lineas: list, clave: str, enc_des: bool)-> list:
    """
...
def new_file(lineas: list, path: str, clave: str, enc_des: bool):
    """
    ...
    with open(path, 'wt') as encripted_file:        
        encripted_lines = encrypter(lineas, clave, enc_des)
...
def main(enc_des:bool):
    ...
    if enc_des is True:
        ...
        new_file(sin_tildes, path, clave, enc_des)
    else:
